...
public class MapFromEntityProfile : Profile
{
    public MapFromEntityProfile()
    {
        ...
        CreateProjection<Play, PlayDto>()
            ...
            .ForMember(d => d.HomeScore, o => o.MapFrom(s => s.HomeScore))
            .ForMember(d => d.AwayScore, o => o.MapFrom(s => s.AwayScore))
            .ForMember(d => d.Quarter, o => o.MapFrom(s => s.Quarter))
            .ForMember(d => d.GameOver, o => o.MapFrom(s => s.Description == "END GAME"))
